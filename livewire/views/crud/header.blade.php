    ...
    <div class="flex flex-col md:flex-row md:flex items-center justify-between">
        ...
        <div class="mt-4 flex justify-end order-1">
            <button type="button" wire:click="save" wire:loading.attr="disabled"
                ...
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded transition  w-full md:w-auto disabled:pointer-events-none">
                @if ($loading)
                    <svg aria-hidden="true" role="status" class="inline w-4 h-4 me-3 text-gray-500 animate-spin"
