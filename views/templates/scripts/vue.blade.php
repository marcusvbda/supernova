                        ...
                        if (comment.test(html)) {
                            ...
                            if (commentEnd >= 0) {
                                if (options.shouldKeepComment) {
                                    options.comment(html.substring(4, commentEnd), index, index + commentEnd +
                                        3);
                                }
                ...
                start: function start(tag, attrs, unary, start$1, end) {
...

                    {
                        if (options.outputSourceRange) {
                            ...
                            element.end = end;
                            element.rawAttrsMap = element.attrsList.reduce(function(cumulated,
                            attr) {
                    ...
                    if (dirRE.test(name)) {
                        ...
                        if (value) {
                            ...
                            if (name === 'v-for') {
                                ...
                                checkFunctionParameterExpression(value, (name + "=\"" + value + "\""), warn,
                                    range);
            ...
            for (var i = 0; i < lines.length; i++) {
                ...
                if (count >= start) {
                    for (var j = i - range; j <= i + range || end > count; j++) {
                        ...
                        res.push(("" + (j + 1) + (repeat$1(" ", 3 - String(j + 1).length)) + "|  " + (lines[
                            j])));
